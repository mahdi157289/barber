    ...
    <section className="py-20 px-6 bg-dark">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold mb-2 font-playfair">{t('social.latestFrom')} <span className="text-gold">{t('social.instagramPlatform')}</span></h3>
          <p className="text-gray-500">{t('social.checkOut')}</p>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3 mb-16">
          {instagramImages.map((img, index) => (
            ...
            >
              <img 
                src={img.src} 
                alt={`${t('social.instagram')} ${index + 1}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          {/* Instagram Card */}
          <a href={settings.instagram} target="_blank" rel="noopener noreferrer" className="group relative bg-linear-to-b from-[#1a1a1a] to-[#0d0d0d] rounded-2xl p-8 border border-gold/20 hover:border-gold transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(201,162,39,0.2)] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-bold text-white mb-1 font-playfair">{t('social.instagramPlatform')}</h4>
              <p className="text-gray-500 text-sm mb-3">@{settings.siteTitle.replace(/\s+/g, '').toLowerCase()}</p>
              <span className="text-gold font-semibold text-lg">25.4K</span>
              <span className="text-gray-500 text-xs block">{t('social.followers')}</span>
            </div>
          </a>

          {/* Facebook Card */}
          <a href={settings.facebook} target="_blank" rel="noopener noreferrer" className="group relative bg-linear-to-b from-[#1a1a1a] to-[#0d0d0d] rounded-2xl p-8 border border-gold/20 hover:border-gold transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(201,162,39,0.2)] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-bold text-white mb-1 font-playfair">{t('social.facebookPlatform')}</h4>
              <p className="text-gray-500 text-sm mb-3">{settings.siteTitle}</p>
          ...
          {/* TikTok Card */}
          <a href={settings.tiktok} target="_blank" rel="noopener noreferrer" className="group relative bg-linear-to-b from-[#1a1a1a] to-[#0d0d0d] rounded-2xl p-8 border border-gold/20 hover:border-gold transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(201,162,39,0.2)] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-bold text-white mb-1 font-playfair">{t('social.tiktokPlatform')}</h4>
              <p className="text-gray-500 text-sm mb-3">@{settings.siteTitle.replace(/\s+/g, '').toLowerCase()}</p>
        ...
        <div className="text-center mt-12">
          <a href={settings.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-10 py-4 bg-transparent border-2 border-gold text-gold font-semibold uppercase tracking-widest hover:bg-gold hover:text-dark transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(201,162,39,0.3)]">
